...
export const ERROR_MESSAGES = {
  ...
  MAX_SUBSCRIBERS_REACHED: 'max subscribers reached',
}
...
class Subject<T> {
  ...
  constructor(initialValue: T, options?: SubjectConstructorOptions) {
    this.options = {
      ...
      maxSubscribers:
        typeof options === 'object' && typeof options.maxSubscribers === 'number' ?
  ...
  subscribe(
    ...
    if (this.subscriberId === this.options.maxSubscribers) {
      throw (ERROR_MESSAGES.MAX_SUBSCRIBERS_REACHED);
    }
